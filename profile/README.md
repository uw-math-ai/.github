...
The University of Washington Math AI Lab ([ai.math.uw.edu](http://ai.math.uw.edu)) is a research and education organization focused on using AI for math. Over the past four years we have had **58** projects, with **169** undergraduate students, **17** graduate students and **10** professors. Most of them have been Lean formalization projects, with about half hosted at [github.com/orgs/uw-math-ai](https://github.com/orgs/uw-math-ai). We have also taught four courses on Lean ([one](https://sites.math.washington.edu//~jarod/math480-spring25.html), [two](https://sites.math.washington.edu/~jarod/math583E-fall25.html), [three](https://github.com/leanprover-community/leanprover-community.github.io/blob/lean4/data/courses.yaml#L233-L240), [four](https://math.washington.edu/events/2025-04-17/formalizing-engineering-mathematics-lean)), with two more scheduled this academic year. We are supported by the [UW eScience Institute](https://escience.washington.edu/), UW IT Research Computing, AWS, and [Nebius](https://nebius.com/).

We have formalized regular local rings ([link](https://github.com/leanprover-community/mathlib4/pull/29574#issuecomment-3283261738)), parts of LADR ([link](https://github.com/Vilin97/linear-algebra-done-right)), FRACTRAN ([link](https://github.com/sanchace/FRACTRAN)), polyhedrals ([link](https://github.com/uw-math-ai/lean-polyhedral-geometry)), intro to proofs textbook ([link](https://github.com/StevennZZZ/FormalizingMATH300)), some generating functions ([link](https://github.com/kcaze/generating-functions)), Hopf algebras ([link](https://github.com/leomayer1/Hopf)), continued fractions ([link](https://github.com/leomayer1/cont_frac)), Zariski topology ([link](https://github.com/leomayer1/zariski_spaces)), smooth rings ([link](https://github.com/HastinKapoor/CInfinityLoci)), random graphs ([link](https://github.com/uw-math-ai/random_graphs)), stacks ([link](https://github.com/uw-math-ai/formalizing-stacks)), parts of CLT ([link](https://github.com/uw-math-ai/central_limit_theorem)), Fibonacci identities ([link](https://github.com/uw-math-ai/LLL/blob/master/lawrence/fib%20stuff.lean)), point-set topology ([link](https://github.com/uw-math-ai/LLL/tree/master/Luca)), Hillbert’s geometry axoims ([link](https://github.com/uw-math-ai/LLL/blob/master/Edward%20%26%20Rico/core.lean)), homological algebra ([link](https://github.com/uw-math-ai/LLL/tree/master/Zachary)), technical lemmas in AG ([link](https://github.com/uw-math-ai/LLL/blob/master/Raymond/principal_again.lean)), dependently-typed SK Combinator ([link](https://lexzaiello.com/posts/skm/introduction/)). We have contributed to mathlib ([1](https://github.com/leanprover-community/mathlib4/pull/19798), [2](https://github.com/leanprover-community/mathlib4/pull/19896), [3](https://github.com/leanprover-community/mathlib4/pull/19886), [4](https://www.google.com/url?q=https://urldefense.com/v3/__https://github.com/leanprover-community/mathlib4/pull/4593__;!!K-Hz7m0Vt54!iAlogRJo1SSnxU2mfQcpOUSO5xrSg_XfBpUmvhEWp45jYuSx1Kh_JXin1BZhY-qXzbUThSpjUQ$&source=gmail&ust=1765668514631000&usg=AOvVaw0BsnrOy5WBzfWv1VLwRhU9), [5](https://github.com/leanprover-community/mathlib4/pull/29574), [6](https://github.com/leanprover-community/mathlib4/pull/32824), [7](https://github.com/leanprover-community/mathlib4/pull/32851)) and done some meta-programming ([link](https://github.com/uw-math-ai/provable_computation)). We have also built semantic search over all theorems on Arxiv ([link](https://huggingface.co/spaces/uw-math-ai/theorem-search)), trained some LLMs for Lean ([1](https://github.com/uw-math-ai/autoformalization-with-llms), [2](https://github.com/uw-math-ai/lean-error-correction)) and for math ([link](https://github.com/uw-math-ai/dl-nt)), did some RL for polynomials ([link](https://github.com/uw-math-ai/PolyArithmeticCircuitsRL)), made a widget to display LaTeX in Lean ([link](https://github.com/kcaze/LatexInLean)), and published preprints ([1](https://huggingface.co/papers/2602.05216), [2](https://huggingface.co/papers/2602.02990)).
